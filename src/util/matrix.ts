...
export function connectMatrixToRight<T>(matrix1: T[][], matrix2: T[][]) {
...
export function connectMatrixToBottom<T>(matrix1: T[][], matrix2: T[][]) {
  return matrix1.concat(matrix2);
}

export function* getZigZagOrder(length: number) {
